...
<style>
	...
	table#tbl-board{width:100%; margin:0 auto; border-top: 2px solid rgb(156, 126, 49); border-collapse:collapse; clear:both; }
	table#tbl-board th, table#tbl-board td {border-top: 2px solid rgb(156, 126, 49); padding: 5px 0; text-align:center; color: rgb(85, 85, 85);} 
	/*페이지바*/
